...
//     db.pool.query('INSERT INTO users (name, email) VALUES ($1, $2)', [name, email], (error, result) => {
//         if (error) {
//             throw error
//         }
...
//     const id = parseInt(request.params.id)
//     const { name, email } = request.body
//     db.pool.query('UPDATE users SET name = $1, email = $2 WHERE id = $3', [name, email, id], (error, results) => {
//         if(error){
//             throw error
//         }
